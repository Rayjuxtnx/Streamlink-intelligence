...
const services = [
  {
    icon: Globe,
    title: 'ISP & Network Solutions',
    description: 'Reliable, high-performance connectivity solutions.',
    link: '/services#isp',
  },
  {
    icon: Cloud,
  ...
  },
  {
    ...
    description: 'Protecting systems, data, and digital assets.',
    link: '/services#cybersecurity',
  },
  {
    icon: Code2,
    title: 'Web & System Development',
    description: 'Custom websites, platforms, and enterprise systems.',
    link: '/services#web-development',
  },
  {
    icon: Briefcase,
    title: 'IT Consulting & Support',
    description: 'Strategic IT solutions for growth and efficiency.',
